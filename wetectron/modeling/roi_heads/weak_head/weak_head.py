...
class ROIWeakHead(torch.nn.Module):
    ...
    def forward(self, images, features, proposals, targets=None, model_cdb=None, path=None):
        """
        Arguments:
        ...
        loss_img, accuracy_img = self.loss_evaluator(images, [cls_score], [det_score], ref_scores, proposals, targets, path)
