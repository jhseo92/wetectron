...
class Triplet_Loss(nn.Module):
    ...
    def __init__(self):
        ...
        self.triplet_loss_l2 = nn.TripletMarginWithDistanceLoss(
                                distance_function=nn.PairwiseDistance(p=2), margin=-.5)
    ...
    def forward(self, anchor, positive, negative):
        ...
        pos_dist = self.pair_dist(anchor, positive)
        neg_dist = self.pair_dist(anchor, negative)
        norm_dist = torch.cat((pos_dist, neg_dist))
